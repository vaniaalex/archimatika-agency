        ...
        <div class='block-1'>
          ...
          <div class='row'>
            ...
            <div class='card'>
              ...
              <translate-wrapper :delay='0.5'>
                <h4>Maintain corporate identity, brand positioning, differentiation strategy
                </h4>
              </translate-wrapper>
            </div>
            <div class='card'>
  ...
  methods: {
    ...
    animateSpinner() {
      if (process.client) {
        ...
        this.tlSpinnerImages.from([this.$refs.spinnerImage1, this.$refs.spinnerImage3, this.$refs.spinnerImage2],
          {
            duration: 1.5,
            opacity: 0,
            stagger: 0.4,
